...
export const BUILTIN_MODULES: ModuleManifest[] = [
  ...
  },
  {
    ...
    features: ['One-click setup','Real Estate','SaaS / Software','Consulting & Services','Recruitment & HR','Insurance','Healthcare & Clinics','Education & Training','E-Commerce & Retail','Legal & Law Firms','Fitness & Wellness','Travel & Tourism','Automotive & Dealerships','Financial Services','Construction & Contracting','Restaurant & Hospitality','Manufacturing & Industrial','Nonprofit & Fundraising','Media & Entertainment','Logistics & Shipping','Professional Services'],
    permissions: [],
