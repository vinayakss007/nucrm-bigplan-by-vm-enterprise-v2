...
export const MODULES: MarketingModule[] = [
  ...
  },
  {
    ...
    summary: 'Branded, print-ready quotes generated from your catalogue, sent by email, with view tracking.',
    features: ['Print-ready output', 'Template selection', 'Line items', 'Send by email', 'Track views'],
    addOn: 15,
    from: 'starter',
    includedIn: ['enterprise'],
  },
  ...
  },
  {
    ...
    features: ['Custom report builder', 'Funnel analytics', 'CSV export', 'Scheduled email reports', 'Revenue forecasting'],
    addOn: 15,
    from: 'pro',
    includedIn: ['enterprise'],
  },
