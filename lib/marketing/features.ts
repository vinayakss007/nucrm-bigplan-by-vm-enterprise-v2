...
export const PILLARS: Pillar[] = [
    ...
    capabilities: [
      {
        ...
        items: [
          ...
          'At-risk and churn detection with configurable rules',
    ...
    capabilities: [
      ...
      },
      {
        ...
        items: [
          ...
          'Approval requests for discounts, quotes and contracts',
  ...
  },
  {
    ...
    highlights: [
      { title: 'Quote in a click', desc: 'Build line items from your catalogue and price books, apply tax, produce a branded print-ready document and send it.', icon: 'FileSignature' },
      ...
      { title: 'Recurring revenue', desc: 'Subscriptions with trials, upgrades and downgrades, with renewal reminders on a schedule.', icon: 'RefreshCw' },
    ],
    capabilities: [
      {
        heading: 'Sell',
        items: [
          ...
          'Quotes with line items, discounts, approval workflow and print-ready output',
          'Public offer links with accept/decline tracking',
          'E-signature requests with a full signing event log',
          'Approval requests for anything above a threshold you define',
        ],
      },
      {
        heading: 'Fulfil & bill',
        items: [
          ...
          'Invoices with line items, payment tracking and partial payments',
          'Automatic tax calculation with multi-jurisdiction rates and exemptions',
          'Multi-currency with live exchange rates and reporting in your base currency',
        ],
      },
      {
        heading: 'Documents',
        items: [
          ...
          'Branded, print-ready documents for quotes and invoices (print or save to PDF from the browser)',
  ...
  },
  {
    ...
    highlights: [
      ...
      { title: 'Delivered on schedule', desc: 'Reports emailed daily, weekly or monthly as CSV to whoever needs them.', icon: 'CalendarClock' },
    ],
    capabilities: [
      {
        heading: 'Build',
...
export const FEATURE_CATALOG: {
  ...
  },
  {
    ...
    accent: 'from-cyan-400 to-blue-500',
    rows: [
      { name: 'Quotes', detail: 'Line items, print-ready output, approval workflow, public offer links, view tracking' },
      { name: 'Offers', detail: 'Public accept/decline links with no customer login required' },
      { name: 'Invoices', detail: 'Line items, tax calculation, payment tracking, print-ready output' },
      ...
      { name: 'Tax & currency', detail: 'Multi-jurisdiction tax, exemptions, multi-currency with live exchange rates' },
  ...
  },
  {
    ...
    rows: [
      ...
      { name: 'At-risk detection', detail: 'Churn-risk detection with configurable rules and alerting' },
  ...
  },
  {
    ...
    rows: [
      ...
      { name: 'Approvals', detail: 'Approval requests for quotes, discounts and contracts with approve/reject and an audit trail' },
  ...
  },
  {
    ...
    rows: [
      ...
      { name: 'Scheduled reports', detail: 'Daily, weekly or monthly CSV delivery by email with execution history' },
