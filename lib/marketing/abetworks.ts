...
export const STUDIO_PRODUCTS: StudioProduct[] = [
  {
    ...
    hook: 'Lead scoring, churn prediction and automated outreach for subscription businesses.',
  ...
  },
  {
    ...
    sub: 'Professional invoices with tax and multi-currency, recurring schedules, payment tracking and an overdue view that makes chasing straightforward.',
