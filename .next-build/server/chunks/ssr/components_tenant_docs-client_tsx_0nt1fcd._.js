module.exports=[228266,a=>{"use strict";var b=a.i(187924),c=a.i(572131),d=a.i(50944),e=a.i(906843),f=a.i(254115),g=a.i(104720),h=a.i(654074),i=a.i(603314),j=a.i(682478),k=a.i(660246),l=a.i(321161),m=a.i(501027),n=a.i(942211),o=a.i(50522),p=a.i(972692),q=a.i(633508),r=a.i(400210),s=a.i(340695),t=a.i(205522),u=a.i(254161),v=a.i(497895);let w={"Getting Started":{icon:j.Rocket,color:"text-emerald-600",items:[{title:"Quick Start",slug:"QUICKSTART",description:"Get up and running in 5 minutes",time:"5 min"},{title:"What is NuCRM?",slug:"README_FINAL",description:"Project overview and features",time:"10 min"},{title:"First Time Setup",slug:"users/first-setup",description:"Initial configuration guide",time:"10 min"},{title:"Tenant Basics",slug:"users/tenant-basics",description:"Understanding tenants and workspaces",time:"10 min"}]},"CRM Core":{icon:k.Users,color:"text-blue-600",items:[{title:"Contacts",slug:"users/contacts",description:"Manage contacts and relationships",time:"10 min"},{title:"Companies",slug:"users/companies",description:"Manage companies and accounts",time:"10 min"},{title:"Leads",slug:"users/leads",description:"Lead capture and qualification",time:"15 min",badge:"NEW"},{title:"Deals",slug:"users/deals",description:"Manage deals and opportunities",time:"10 min"},{title:"Tasks",slug:"users/tasks",description:"Tasks and follow-ups",time:"10 min"},{title:"Activities",slug:"users/activities",description:"Log calls, emails, meetings",time:"10 min"},{title:"Pipelines",slug:"users/pipelines",description:"Pipeline configuration",time:"10 min"}]},"Billing & Finance":{icon:m.Zap,color:"text-amber-600",items:[{title:"Services Catalog",slug:"billing/services",description:"Create and manage services",time:"10 min",badge:"NEW"},{title:"Invoices",slug:"billing/invoices",description:"Create and track invoices",time:"15 min",badge:"NEW"},{title:"Orders",slug:"billing/orders",description:"Order management",time:"10 min",badge:"NEW"},{title:"Contracts",slug:"billing/contracts",description:"Contract lifecycle",time:"10 min",badge:"NEW"},{title:"Subscriptions",slug:"billing/subscriptions",description:"Recurring billing",time:"15 min",badge:"NEW"},{title:"Payments",slug:"billing/payments",description:"Payment tracking",time:"10 min"}]},Marketing:{icon:h.Code,color:"text-violet-600",items:[{title:"Email Sequences",slug:"marketing/sequences",description:"Automated email campaigns",time:"15 min"},{title:"Email Templates",slug:"marketing/templates",description:"Custom email templates",time:"10 min"},{title:"Lead Scoring",slug:"marketing/lead-scoring",description:"Contact scoring",time:"15 min"},{title:"Forms",slug:"marketing/forms",description:"Web forms for lead capture",time:"10 min"},{title:"Landing Pages",slug:"marketing/landing-pages",description:"Create landing pages",time:"10 min"}]},Automation:{icon:m.Zap,color:"text-orange-600",items:[{title:"Workflows",slug:"automation/workflows",description:"Visual automation builder",time:"20 min"},{title:"Triggers & Actions",slug:"automation/triggers",description:"Event-based automation",time:"15 min"},{title:"Webhooks",slug:"automation/webhooks",description:"External integrations",time:"15 min"},{title:"API Integrations",slug:"automation/api",description:"REST API usage",time:"20 min"}]},"Team & Settings":{icon:l.Settings,color:"text-gray-600",items:[{title:"Team Members",slug:"settings/team",description:"Manage team members",time:"10 min"},{title:"Roles & Permissions",slug:"settings/roles",description:"Role-based access control",time:"15 min"},{title:"Invitations",slug:"settings/invitations",description:"Invite team members",time:"10 min"},{title:"Tenant Settings",slug:"settings/tenant",description:"Workspace configuration",time:"10 min"},{title:"Custom Fields",slug:"settings/custom-fields",description:"Add custom fields",time:"15 min"},{title:"API Keys",slug:"settings/api-keys",description:"Generate API keys",time:"10 min"}]},Integrations:{icon:i.Shield,color:"text-cyan-600",items:[{title:"WhatsApp Integration",slug:"integrations/whatsapp",description:"Connect WhatsApp Business",time:"15 min"},{title:"Email Integration",slug:"integrations/email",description:"SMTP and IMAP setup",time:"15 min"},{title:"Webhooks",slug:"integrations/webhooks",description:"Outbound webhooks",time:"10 min"},{title:"Zapier",slug:"integrations/zapier",description:"Connect with Zapier",time:"10 min"}]},"Reports & Analytics":{icon:f.Book,color:"text-green-600",items:[{title:"Reports Dashboard",slug:"reports/dashboard",description:"Built-in reports",time:"10 min"},{title:"Custom Reports",slug:"reports/custom",description:"Build custom reports",time:"15 min"},{title:"Sales Analytics",slug:"reports/sales",description:"Sales performance",time:"10 min"},{title:"Export Data",slug:"reports/export",description:"Export data to CSV",time:"5 min"}]},Security:{icon:i.Shield,color:"text-red-600",items:[{title:"Security Overview",slug:"security/overview",description:"Security architecture",time:"15 min"},{title:"Row Level Security",slug:"security/row-level-security",description:"Database security",time:"10 min"},{title:"2FA Setup",slug:"security/2fa",description:"Two-factor authentication",time:"10 min"},{title:"Audit Logs",slug:"security/audit-logs",description:"View audit trail",time:"10 min"},{title:"Data Privacy",slug:"security/privacy",description:"GDPR compliance",time:"15 min"}]},Deployment:{icon:j.Rocket,color:"text-indigo-600",items:[{title:"Deployment Guide",slug:"deployment/guide",description:"Production deployment",time:"30 min"},{title:"Docker Setup",slug:"deployment/docker",description:"Deploy with Docker",time:"20 min"},{title:"Environment Variables",slug:"deployment/env",description:"Configuration",time:"10 min"},{title:"Backup & Restore",slug:"deployment/backup",description:"Backup procedures",time:"15 min"}]},Support:{icon:n.HelpCircle,color:"text-cyan-600",items:[{title:"FAQ",slug:"support/faq",description:"Frequently asked questions",time:"10 min"},{title:"Troubleshooting",slug:"support/troubleshooting",description:"Common issues",time:"15 min"},{title:"Error Codes",slug:"support/error-codes",description:"Error reference",time:"10 min"},{title:"Contact Support",slug:"support/contact",description:"Get help",time:"5 min"}]}};a.s(["default",0,function(){let a=(0,d.useRouter)(),[h,i]=(0,c.useState)(""),[j,k]=(0,c.useState)(null),[l,m]=(0,c.useState)(null),[n,x]=(0,c.useState)(!0),[y,z]=(0,c.useState)("home"),A=(0,c.useMemo)(()=>{let a=[];return Object.entries(w).forEach(([b,c])=>{c.items.forEach(d=>{a.push({...d,category:b,icon:c.icon,color:c.color})})}),a},[]),B=(0,c.useMemo)(()=>{if(!h.trim())return[];let a=h.toLowerCase();return A.filter(b=>b.title.toLowerCase().includes(a)||b.description.toLowerCase().includes(a)||b.category.toLowerCase().includes(a))},[h,A]),C=(0,c.useMemo)(()=>{if(!j)return[];let a=w[j];return a?a.items:[]},[j]),D=(0,c.useMemo)(()=>{if(!l)return null;let a={QUICKSTART:{title:"Quick Start Guide",content:`# Quick Start Guide
...
- Priority support
- Custom SLAs`}}[l];if(a)return{title:a.title,content:a.content,lastUpdated:"2026-05-10"};let b=l.split("/").pop()?.replace(/[-_]/g," ")||"Documentation";return{title:b,content:`# ${b}

## Overview

This section covers **${b.toLowerCase()}** in NuCRM.
...
Contact support or check the FAQ section for common questions.`,lastUpdated:"2026-05-10"}},[l]),E=a=>{m(a),z("document"),window.innerWidth<768&&x(!1)},F=a=>{k(a),m(null),z("category")},G=()=>{k(null),m(null),z("index")},H=j?w[j]?.icon:f.Book;return(0,b.jsxs)("div",{className:"max-w-7xl mx-auto",children:[(0,b.jsx)("div",{className:"lg:hidden sticky top-14 z-40 bg-background/80 backdrop-blur-lg border-b border-border -mx-4 px-4",children:(0,b.jsxs)("div",{className:"flex items-center justify-between py-2",children:[(0,b.jsxs)("div",{className:"flex items-center gap-2",children:[(0,b.jsx)(s.Button,{variant:"ghost",size:"sm",onClick:()=>x(!n),children:n?(0,b.jsx)(q.X,{className:"w-5 h-5"}):(0,b.jsx)(p.Menu,{className:"w-5 h-5"})}),(0,b.jsx)(f.Book,{className:"w-5 h-5 text-violet-600"}),(0,b.jsx)("h1",{className:"text-sm font-bold",children:"Documentation"})]}),(0,b.jsxs)("div",{className:"relative w-48",children:[(0,b.jsx)(e.Search,{className:"absolute left-2 top-1/2 -translate-y-1/2 w-3.5 h-3.5 text-muted-foreground"}),(0,b.jsx)(t.Input,{value:h,onChange:a=>i(a.target.value),placeholder:"Search docs...",className:"pl-7 h-8 text-xs"})]})]})}),(0,b.jsx)("div",{className:"hidden lg:block sticky top-14 z-40 bg-background/80 backdrop-blur-lg border-b border-border -mx-4 px-4",children:(0,b.jsxs)("div",{className:"flex items-center justify-between py-2",children:[(0,b.jsxs)("div",{className:"flex items-center gap-2",children:[(0,b.jsx)(f.Book,{className:"w-5 h-5 text-violet-600"}),(0,b.jsx)("h1",{className:"text-sm font-bold",children:"Documentation"})]}),(0,b.jsxs)("div",{className:"relative w-full max-w-md",children:[(0,b.jsx)(e.Search,{className:"absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-muted-foreground"}),(0,b.jsx)(t.Input,{value:h,onChange:a=>i(a.target.value),placeholder:"Search documentation...",className:"pl-9 h-9 text-sm"})]})]})}),(0,b.jsxs)("div",{className:"flex gap-4 lg:gap-6 py-4",children:[n&&(0,b.jsxs)("div",{className:(0,v.cn)("fixed lg:sticky top-20 left-0 z-30 w-64 lg:w-72 h-[calc(100vh-5rem)] overflow-y-auto bg-background lg:bg-transparent border-r lg:border-0 border-border p-4 lg:p-0 transition-transform",!n&&"hidden lg:block"),children:[!h&&!l&&(0,b.jsxs)("div",{className:"space-y-2",children:[(0,b.jsxs)(s.Button,{variant:"home"===y?"secondary":"ghost",className:"w-full justify-start",onClick:()=>{k(null),m(null),z("home")},children:[(0,b.jsx)(f.Book,{className:"w-4 h-4 mr-2"}),"Home"]}),(0,b.jsxs)(s.Button,{variant:"index"===y?"secondary":"ghost",className:"w-full justify-start",onClick:G,children:[(0,b.jsx)(g.FileText,{className:"w-4 h-4 mr-2"}),"Index (All Docs)"]}),(0,b.jsx)("div",{className:"text-xs font-semibold text-muted-foreground uppercase tracking-wide mt-4 mb-2",children:"Categories"}),Object.entries(w).map(([a,c])=>{let d=c.icon;return(0,b.jsxs)(s.Button,{variant:j===a?"secondary":"ghost",className:"w-full justify-start",onClick:()=>F(a),children:[(0,b.jsx)(d,{className:(0,v.cn)("w-4 h-4 mr-2",c.color)}),a,(0,b.jsx)(u.Badge,{variant:"secondary",className:"ml-auto text-xs",children:c.items.length})]},a)})]}),j&&!l&&(0,b.jsxs)("div",{className:"space-y-2",children:[(0,b.jsxs)(s.Button,{variant:"ghost",className:"w-full justify-start",onClick:()=>k(null),children:[(0,b.jsx)(o.ChevronRight,{className:"w-4 h-4 mr-2 rotate-180"}),"Back to Categories"]}),C.map(a=>(0,b.jsxs)(s.Button,{variant:"ghost",className:"w-full justify-start text-sm",onClick:()=>E(a.slug),children:[(0,b.jsx)(g.FileText,{className:"w-3 h-3 mr-2 text-muted-foreground"}),a.title]},a.slug))]}),h&&(0,b.jsxs)("div",{className:"space-y-2",children:[(0,b.jsxs)("div",{className:"text-xs font-semibold text-muted-foreground uppercase tracking-wide mb-2",children:["Search Results (",B.length,")"]}),B.map(a=>{let c=w[a.category]?.icon||g.FileText,d=w[a.category]?.color||"text-muted-foreground";return(0,b.jsxs)(s.Button,{variant:"ghost",className:"w-full justify-start text-sm",onClick:()=>E(a.slug),children:[(0,b.jsx)(c,{className:(0,v.cn)("w-3 h-3 mr-2",d)}),(0,b.jsxs)("div",{className:"flex-1 text-left",children:[(0,b.jsx)("div",{className:"text-sm font-medium",children:a.title}),(0,b.jsx)("div",{className:"text-xs text-muted-foreground",children:a.category})]})]},a.slug)})]})]}),(0,b.jsxs)("div",{className:"flex-1 min-w-0",children:[!l&&(0,b.jsxs)(b.Fragment,{children:[!h&&!j&&(0,b.jsxs)("div",{className:"space-y-6",children:[(0,b.jsxs)("div",{className:"text-center py-12",children:[(0,b.jsxs)("div",{className:"flex items-center justify-between max-w-2xl mx-auto mb-2",children:[(0,b.jsx)("div",{}),(0,b.jsxs)(s.Button,{onClick:()=>a.push("/tenant/dashboard"),variant:"outline",size:"sm",className:"gap-1.5 text-xs",children:[(0,b.jsx)(r.ArrowLeft,{className:"w-3.5 h-3.5"}),"Back to CRM"]})]}),(0,b.jsx)(f.Book,{className:"w-16 h-16 text-violet-600 mx-auto mb-4"}),(0,b.jsx)("h2",{className:"text-3xl font-bold mb-2",children:"NuCRM Documentation"}),(0,b.jsx)("p",{className:"text-muted-foreground mb-6",children:"Search and browse 720+ pages of comprehensive documentation"}),(0,b.jsxs)("div",{className:"flex flex-wrap justify-center gap-2",children:[(0,b.jsx)(u.Badge,{variant:"secondary",children:"60+ Documents"}),(0,b.jsx)(u.Badge,{variant:"secondary",children:"400+ Pages"}),(0,b.jsx)(u.Badge,{variant:"secondary",children:"11 Categories"})]}),(0,b.jsx)("div",{className:"flex justify-center gap-3",children:(0,b.jsxs)(s.Button,{onClick:G,variant:"outline",children:[(0,b.jsx)(g.FileText,{className:"w-4 h-4 mr-2"}),"Browse Index"]})})]}),(0,b.jsx)("div",{className:"grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4",children:Object.entries(w).map(([a,c])=>{let d=c.icon;return(0,b.jsxs)("button",{onClick:()=>F(a),className:"admin-card p-6 hover:border-violet-500/30 hover:shadow-lg transition-all text-left",children:[(0,b.jsxs)("div",{className:"flex items-center gap-3 mb-3",children:[(0,b.jsx)("div",{className:(0,v.cn)("p-2 rounded-lg bg-muted",c.color),children:(0,b.jsx)(d,{className:"w-5 h-5"})}),(0,b.jsx)("h3",{className:"font-semibold",children:a})]}),(0,b.jsxs)("p",{className:"text-sm text-muted-foreground mb-3",children:[c.items.length," documents"]}),(0,b.jsxs)("div",{className:"space-y-1",children:[c.items.slice(0,3).map(a=>(0,b.jsxs)("div",{className:"text-xs text-muted-foreground flex items-center justify-between",children:[(0,b.jsx)("span",{className:"truncate",children:a.title}),(0,b.jsx)("span",{className:"text-[10px] bg-muted px-1 rounded",children:a.time})]},a.slug)),c.items.length>3&&(0,b.jsxs)("div",{className:"text-xs text-violet-600",children:["+",c.items.length-3," more..."]})]})]},a)})})]}),j&&"category"===y&&(0,b.jsxs)("div",{className:"space-y-4",children:[(0,b.jsxs)("div",{className:"flex items-center gap-2 mb-4",children:[(0,b.jsxs)(s.Button,{variant:"ghost",size:"sm",onClick:()=>z("index"),children:[(0,b.jsx)(o.ChevronRight,{className:"w-4 h-4 mr-2 rotate-180"}),"Back to Index"]}),H&&(0,b.jsx)(H,{className:(0,v.cn)("w-5 h-5",w[j]?.color)}),(0,b.jsx)("h2",{className:"text-2xl font-bold",children:j})]}),(0,b.jsx)("div",{className:"space-y-2",children:C.map(a=>(0,b.jsx)("button",{onClick:()=>E(a.slug),className:"w-full admin-card p-4 hover:border-violet-500/30 hover:shadow-md transition-all text-left",children:(0,b.jsxs)("div",{className:"flex items-center justify-between",children:[(0,b.jsxs)("div",{className:"flex-1",children:[(0,b.jsxs)("div",{className:"flex items-center gap-2",children:[(0,b.jsx)(g.FileText,{className:"w-4 h-4 text-muted-foreground"}),(0,b.jsx)("h3",{className:"font-semibold",children:a.title}),a.badge&&(0,b.jsx)(u.Badge,{className:"text-xs",children:a.badge})]}),(0,b.jsx)("p",{className:"text-sm text-muted-foreground mt-1",children:a.description})]}),(0,b.jsx)("div",{className:"text-xs text-muted-foreground bg-muted px-2 py-1 rounded",children:a.time})]})},a.slug))})]}),"index"===y&&(0,b.jsxs)("div",{className:"space-y-6",children:[(0,b.jsxs)("div",{className:"flex items-center justify-between mb-4 flex-wrap gap-2",children:[(0,b.jsxs)("div",{className:"flex items-center gap-2",children:[(0,b.jsx)(g.FileText,{className:"w-6 h-6 text-violet-600"}),(0,b.jsx)("h2",{className:"text-2xl font-bold",children:"Documentation Index"}),(0,b.jsxs)(u.Badge,{variant:"secondary",children:[A.length," documents"]})]}),(0,b.jsxs)(s.Button,{variant:"outline",size:"sm",className:"gap-1.5 text-xs",onClick:()=>a.push("/tenant/dashboard"),children:[(0,b.jsx)(r.ArrowLeft,{className:"w-3.5 h-3.5"}),"Back to CRM"]}),(0,b.jsxs)("div",{className:"text-sm text-muted-foreground",children:[Object.keys(w).length," categories"]})]}),(0,b.jsxs)("div",{className:"grid grid-cols-2 md:grid-cols-4 gap-3",children:[(0,b.jsxs)("div",{className:"admin-card p-4 text-center",children:[(0,b.jsx)("div",{className:"text-2xl font-bold text-violet-600",children:A.length}),(0,b.jsx)("div",{className:"text-xs text-muted-foreground",children:"Total Docs"})]}),(0,b.jsxs)("div",{className:"admin-card p-4 text-center",children:[(0,b.jsx)("div",{className:"text-2xl font-bold text-emerald-600",children:"400+"}),(0,b.jsx)("div",{className:"text-xs text-muted-foreground",children:"Pages"})]}),(0,b.jsxs)("div",{className:"admin-card p-4 text-center",children:[(0,b.jsx)("div",{className:"text-2xl font-bold text-blue-600",children:Object.keys(w).length}),(0,b.jsx)("div",{className:"text-xs text-muted-foreground",children:"Categories"})]}),(0,b.jsxs)("div",{className:"admin-card p-4 text-center",children:[(0,b.jsx)("div",{className:"text-2xl font-bold text-amber-600",children:A.filter(a=>a.badge).length}),(0,b.jsx)("div",{className:"text-xs text-muted-foreground",children:"New This Week"})]})]}),Object.entries(w).map(([a,c])=>{let d=c.icon;return(0,b.jsxs)("div",{className:"admin-card",children:[(0,b.jsxs)("div",{className:"flex items-center gap-3 p-4 border-b border-border bg-muted/30",children:[(0,b.jsx)("div",{className:(0,v.cn)("p-2 rounded-lg bg-muted",c.color),children:(0,b.jsx)(d,{className:"w-5 h-5"})}),(0,b.jsx)("h3",{className:"font-semibold text-lg",children:a}),(0,b.jsxs)(u.Badge,{variant:"secondary",className:"ml-auto",children:[c.items.length," docs"]})]}),(0,b.jsx)("div",{className:"divide-y divide-border",children:c.items.map(a=>(0,b.jsxs)("button",{onClick:()=>E(a.slug),className:"w-full p-4 hover:bg-accent/50 transition-colors text-left flex items-center gap-3",children:[(0,b.jsx)(g.FileText,{className:"w-4 h-4 text-muted-foreground shrink-0"}),(0,b.jsxs)("div",{className:"flex-1 min-w-0",children:[(0,b.jsxs)("div",{className:"flex items-center gap-2",children:[(0,b.jsx)("span",{className:"font-medium truncate",children:a.title}),a.badge&&(0,b.jsx)(u.Badge,{className:"text-xs shrink-0",children:a.badge})]}),(0,b.jsx)("p",{className:"text-xs text-muted-foreground truncate",children:a.description})]}),(0,b.jsx)("div",{className:"text-xs text-muted-foreground shrink-0",children:a.time}),(0,b.jsx)(o.ChevronRight,{className:"w-4 h-4 text-muted-foreground shrink-0"})]},a.slug))})]},a)})]}),h&&(0,b.jsxs)("div",{className:"space-y-4",children:[(0,b.jsxs)("div",{className:"flex items-center gap-2 mb-4",children:[(0,b.jsx)(e.Search,{className:"w-5 h-5 text-muted-foreground"}),(0,b.jsxs)("h2",{className:"text-2xl font-bold",children:['Search Results for "',h,'"']}),(0,b.jsxs)(u.Badge,{variant:"secondary",children:[B.length," results"]})]}),0===B.length?(0,b.jsxs)("div",{className:"text-center py-12 text-muted-foreground",children:[(0,b.jsx)(e.Search,{className:"w-12 h-12 mx-auto mb-4 opacity-30"}),(0,b.jsx)("p",{className:"text-lg font-semibold",children:"No results found"}),(0,b.jsx)("p",{className:"text-sm",children:"Try different keywords or browse categories"})]}):(0,b.jsx)("div",{className:"space-y-2",children:B.map(a=>{let c=w[a.category]?.icon||g.FileText,d=w[a.category]?.color||"text-muted-foreground";return(0,b.jsx)("button",{onClick:()=>E(a.slug),className:"w-full admin-card p-4 hover:border-violet-500/30 hover:shadow-md transition-all text-left",children:(0,b.jsxs)("div",{className:"flex items-start gap-3",children:[(0,b.jsx)(c,{className:(0,v.cn)("w-5 h-5 mt-0.5",d)}),(0,b.jsxs)("div",{className:"flex-1",children:[(0,b.jsxs)("div",{className:"flex items-center gap-2",children:[(0,b.jsx)("h3",{className:"font-semibold",children:a.title}),a.badge&&(0,b.jsx)(u.Badge,{className:"text-xs",children:a.badge})]}),(0,b.jsx)("p",{className:"text-sm text-muted-foreground mt-1",children:a.description}),(0,b.jsxs)("div",{className:"flex items-center gap-3 mt-2 text-xs text-muted-foreground",children:[(0,b.jsxs)("span",{className:"flex items-center gap-1",children:[(0,b.jsx)(f.Book,{className:"w-3 h-3"}),a.category]}),(0,b.jsxs)("span",{className:"flex items-center gap-1",children:[(0,b.jsx)(g.FileText,{className:"w-3 h-3"}),a.time]})]})]})]})},a.slug)})})]})]}),l&&D&&(0,b.jsxs)("div",{className:"space-y-4",children:[(0,b.jsxs)("div",{className:"flex items-center gap-2 mb-4",children:[(0,b.jsxs)(s.Button,{variant:"ghost",size:"sm",onClick:()=>m(null),children:[(0,b.jsx)(o.ChevronRight,{className:"w-4 h-4 mr-2 rotate-180"}),"Back"]}),(0,b.jsx)(u.Badge,{variant:"secondary",children:A.find(a=>a.slug===l)?.category||"Documentation"})]}),(0,b.jsx)("div",{className:"admin-card p-8",children:(0,b.jsxs)("div",{className:"prose prose-sm max-w-none dark:prose-invert",children:[(0,b.jsx)("h1",{className:"text-3xl font-bold mb-4",children:D.title}),(0,b.jsxs)("div",{className:"text-sm text-muted-foreground mb-6 flex items-center gap-2",children:[(0,b.jsx)(g.FileText,{className:"w-4 h-4"}),"Last updated: ",new Date(D.lastUpdated).toLocaleDateString()]}),(0,b.jsx)("div",{className:"whitespace-pre-wrap text-sm leading-relaxed",children:D.content})]})})]})]})]})]})}])}];

//# sourceMappingURL=components_tenant_docs-client_tsx_0nt1fcd._.js.map