...
describe('env - 100% coverage', () => {
  describe('initEnv', () => {
    ...
    beforeEach(() => {
      ...
      // High-entropy fixtures (>2 unique chars) so they pass validateNotWeak();
      // lengths preserved: JWT/SESSION 48, ENCRYPTION_KEY 64, CRON_SECRET 32.
      process.env.JWT_SECRET = '9a1c3e5b7d2f4068'.repeat(3);
      process.env.SESSION_SECRET = 'b2e8d4f6a0c91537'.repeat(3);
      process.env.ENCRYPTION_KEY =
        '4d6b8f0a2c9e1b3d5f7a9c0e2b4d6f8a1c3e5b7d9f0a2c4e6b8d1f3a5c7e9b0d';
      process.env.NEXT_PUBLIC_APP_URL = 'http://localhost:3000';
      process.env.SETUP_KEY = 'a'.repeat(24);
      process.env.ALLOWED_ORIGINS = '*';
      process.env.CRON_SECRET = '9a1c3e5b7d9f2a4c6e8b0d1f3a5c7e9b';
      process.env.DATABASE_POOL_SIZE = '5';
