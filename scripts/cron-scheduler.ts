...
const JOBS: CronJob[] = [
  ...
  { name: 'backup-verify',      path: '/api/cron/backup-verify',       schedule: '0 4 * * *',         intervalMs: 24 * 60 * 60_000 },
  ...
  { name: 'recurring-invoice-generator', path: '/api/cron/recurring-invoice-generator', schedule: '0 6 * * *',        intervalMs: 24 * 60 * 60_000 },
