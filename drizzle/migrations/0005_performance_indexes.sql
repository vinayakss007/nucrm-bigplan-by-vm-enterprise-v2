...
DROP INDEX IF EXISTS idx_tasks_tenant_created;
...
DROP INDEX IF EXISTS idx_lead_activities_tenant_created;
DROP INDEX IF EXISTS idx_lead_activities_lead;
DROP INDEX IF EXISTS idx_lead_activities_type;
DROP INDEX IF EXISTS idx_sequence_enrollments_active;
DROP INDEX IF EXISTS idx_sequence_enrollments_contact;
DROP INDEX IF EXISTS idx_sequence_enrollments_next;
DROP INDEX IF EXISTS idx_notifications_unread;
DROP INDEX IF EXISTS idx_notifications_recent;
