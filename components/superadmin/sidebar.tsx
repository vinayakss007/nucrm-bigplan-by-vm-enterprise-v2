    ...
    <aside className="w-[15rem] shrink-0 h-full flex flex-col transition-all duration-200 bg-card border-r border-border">
        ...
        {filtered.map(section => {
          ...
          return (
            <div key={section.id} className="space-y-0.5">
              ...
              >
                <span className="text-xs font-extrabold uppercase tracking-widest text-foreground/70 group-hover:text-foreground transition-colors">
                  {section.label}
                </span>
                {!q && (
      ...
      <div className="p-2.5 shrink-0 border-t border-border">
        <button onClick={logout}
          className="w-full flex items-center gap-2.5 px-3 py-2 rounded-lg text-xs font-medium mb-1 transition-all duration-200 hover:bg-red-50 dark:hover:bg-red-950/20 hover:text-red-500 dark:hover:text-red-400 text-foreground/80 hover:scale-[1.02]">
