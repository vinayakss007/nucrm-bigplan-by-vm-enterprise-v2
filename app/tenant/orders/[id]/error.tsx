...
export default function OrderDetailError({ error, reset }: { error: Error; reset: () => void }) {
  useEffect(() => { Sentry.captureException(error); console.error('[order detail error]', error); }, [error]);
  return (
