...
export default function SubscriptionDetailError({ error, reset }: { error: Error; reset: () => void }) {
  useEffect(() => { Sentry.captureException(error); console.error('[subscription detail error]', error); }, [error]);
  return (
