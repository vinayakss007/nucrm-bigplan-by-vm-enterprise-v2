...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    void logError({ error: err, context: 'webhook-razorpay:signature-verification', level: 'warning' });
  ...
  try {
    ...
    void logError({ error: err, context: 'webhook-razorpay:process-event', metadata: { eventType } });
