...
> "Super-admin" = platform operator with cross-tenant access. This is distinct from a *workspace
> admin*, who only administers a single tenant.
...
| Aspect | Summary |
| --- | --- |
| **Product** | NuCRM Enterprise — multi-tenant SaaS CRM (v0.4.0) |
